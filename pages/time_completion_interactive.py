...
feedback = st.text_area("Please enter any suggestions or comments you have for this interactive phase (optional)")
...
if st.button("Submit"):
    ...
    users_collection.update_one(
        ...
        {"$set": {
            f"phases.interactive.batches.{batch_id}.time_completion": {
