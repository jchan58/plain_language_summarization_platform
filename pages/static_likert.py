...
def logout_confirm_dialog(prolific_id):
    st.markdown(
        "Your progress will not be saved until you finish this abstract, which happens after you complete the **Compare SUMMARY to ABSTRACT** questionnaire and click the **Next Abstract** button on this page. "
    ...
    with main:
        ...
        **5 = Excellent**  
        ...
        if st.session_state.get("user_confirmed_next", False):
            ...
            abstracts = user["phases"]["static"]["batches"][batch_id]["abstracts"]
            next_abstract = None
