...
if not st.session_state.get("logged_in", False):
    ...
    st.markdown("""
    By entering your Prolific ID you agree to our [Terms and Conditions](https://docs.google.com/document/d/1wfvGWg69Vg3xroLDxpJXwe1_KWY72w0Z4ut59hA5iTM/edit?usp=sharing).
    """, unsafe_allow_html=True)

    prolific_id = st.text_input("Please enter your Prolific ID to begin annotating").strip()
    if st.button("Enter"):
        if not prolific_id:
        ...
        if not user:
            ...
            # insert new user record with all assigned abstracts
